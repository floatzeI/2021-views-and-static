...
export default (
	...
	const formattedDate =
		(data.date && moment(data.date).format(`M/D/YYYY hh:mm:ss A`)) ||
		'No Date Available';
    ...
    <div class="not-approved-page-content">
        <div class="not-approved-page">
            <div class="message-container">
                ...
                <p class="message-section">Our content monitors have determined that your behavior at Roblox has been in violation of our <a href='https://www.roblox.com/info/terms' target='_blank'>Terms of Use</a>.</p>
                <p class="message-section" id="punishment-created">Reviewed: <b>${formattedDate}</b> (EST)</p>
                <p class="message-section" id="moderator-note"> Moderator Note: <b>${data.reason || 'No Reason Specified'
		}</b></p>
		...
		<script>
			function post(url, data) {
				return new Promise(function(res, rej) {
					$.ajax({
								...
								complete: function(xhr, status) {
									...
									if (newCsrf) {
										Roblox.XsrfToken.setToken(newCsrf);
				...
				$(document).on('click', '#logout-button', function(e) {
					post(Roblox.EnvironmentUrls.authApi + '/v2/logout', '{}').then(function() {
    ...
    <script src='/src/js/XsrfToken.js'></script>
