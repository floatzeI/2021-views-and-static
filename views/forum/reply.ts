...
<td align="left" colspan="2">
    <h2 id="ctl00_cphRoblox_PostView1_ctl00_PostTitle" cssclass="notranslate">Reply to Post</h2>
</td>
</tr>
<tr>
...
<tr>
    <td class="forumHeaderBackgroundAlternate" colspan="2" style="height:20px;">
        <table class="forum-table-header" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:collapse;">
            <tbody>
                <tr style="background-color: rgb(45, 82, 143);color:white;">
                    <td class="tableHeaderText table-header-right-center" align="center" style="padding-top: 0.5rem;
                    padding-bottom: 0.5rem;">Original Post</td>
                </tr>
            </tbody>
        </table>
    </td>
...
<tr class="forum-content-background">
    <td colspan="2">
        <p style="font-size:13px;color:rgb(45, 82, 143);">
            <a href="/Forum/ShowPost.aspx?PostID=${postData.id}">${xss(
			postData.title
		)}</a>
        </p>
    
    <p style="font-size:13px;padding-bottom: 10px;">Posted by <a style="color:rgb(45, 82, 143);" href="/users/${postData.userId
		}/profile">${xss(postData.username)}</a> on ${moment(
			postData.createdAt
		).format('MM-DD-YYYY hh:MM A')}</p>
    <p style="padding-bottom: 10px;font-size:13px;">${xss(
			postData.post
		).replace(/\n/g, '<br />')}</p>
    </td>
</tr>
    ...
    <td class="forumHeaderBackgroundAlternate" colspan="2" style="height:20px;">
        <table class="forum-table-header" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:collapse;">
            <tbody>
                <tr style="background-color: rgb(45, 82, 143);color:white;">
                    <td class="tableHeaderText table-header-right-center" align="center" style="padding-top: 0.5rem;
                    padding-bottom: 0.5rem;">New Post</td>
                </tr>
            </tbody>
        </table>
    </td>
...
<tr class="forum-content-background">
    <td colspan="1" style="display: block;">
        <table style="float: right;">
            <tbody>
                <tr>
                    <td style="text-align:right;font-weight:500;" align="right">
                        Subject:
                    </td>
                </tr>
                <tr>
                    <td style="text-align:right;font-weight:500;padding-bottom:280px;padding-top:16px;" align="right">
                        Message:
                    </td>
                </tr>
                <tr>
                    <td style="text-align:right;font-weight:500;padding-top:5px;" align="right">
                        Signature:
                    </td>
                </tr>
            </tbody>
    ...
    <td colspan="1">
        <table style="width: 95%;">
            <tbody>
                <tr>
                    <td style="text-align:left;overflow: hidden;text-overflow: ellipsis;max-width: 500px;white-space: nowrap;padding-left: 15px;padding-bottom: 15px;" align="left">
                        Re: ${xss(postData.title)}
                    </td>
                </tr>
                <tr>
                    <td style="text-align:left;padding-left: 15px;" align="left">
                        <textarea style="width:100%;height:300px;" id="robloxThreadReplyBodyTextArea"></textarea>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:left;padding-left: 15px;" align="left">
                        <textarea style="width:100%;height:50px;" id="robloxThreadReplySignatureArea"></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
...
<tr class="forum-content-background" style="color: rgb(0, 0, 0);">
    <td colspan="2" style="padding-bottom:2px;padding-top:10px;">
        <button style="float:right;background-color: rgba(0,0,0,.1);border-color: rgba(0,0,0,.1);padding: 2px 6px;" type="submit" name="ctl00$cphRoblox$ThreadView1$ctl00$SearchButton" id="robloxThreadCreateOnClick" class="translate btn-control btn-control-medium forum-btn-control-medium"> Create </button>
    </td>
</tr>
            ...
            <!-- right column -->
			<td id="ctl00_cphRoblox_RightColumn" class="RightColumn" style="padding-top:88px;" width="160" nowrap="nowrap">
			
<iframe name="Roblox_Forums_Right_160x600" allowtransparency="true" scrolling="no" src="http://www.roblox.com/userads/2" data-js-adtype="iframead" r12go7kas="" width="160" height="612" frameborder="0"></iframe>
...
<script>
    $("#robloxThreadSubjectTextArea").text(localStorage.getItem("roblox_signature_v1") || "")
    $(document).on('click', '#robloxThreadCreateOnClick', function(e) {
        e.preventDefault();
        var btn = $(this);
        btn.attr('disabled', 'disabled');
        var signature = $("#robloxThreadSubjectTextArea").val();
        localStorage.setItem("roblox_signature_v1", signature);
        $.ajax({
            method: "POST",
            url: "/Forum/SubmitPost.aspx",
            data: {
                "body": $('#robloxThreadReplyBodyTextArea').val(),
                "postId": ${postData.id},
            }
            ...
            if (result.error) {
                ...
                window.location.href = "/Forum/ShowPost.aspx?PostID=" + result.data.PostID;
            }
        }).always(function() {
