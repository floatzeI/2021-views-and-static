...
export default (session: IUserInfo, category: any, subCategory: any) => {
...
<td align="left" colspan="2">
    <h2 id="ctl00_cphRoblox_PostView1_ctl00_PostTitle" cssclass="notranslate" >New Post</h2>
</td>
</tr>
<tr>
...
<tr class="forum-content-background">
    ...
    <td colspan="1">
        <table style="width: 95%;">
            <tbody>
                <tr>
                    <td style="text-align:left;overflow: hidden;text-overflow: ellipsis;max-width: 500px;white-space: nowrap;padding-left: 15px;" align="left">
                        <textarea rows="1" style="width:100%;" id="robloxThreadSubjectTextArea"></textarea>
                    </td>
                </tr>
                <tr>
...
<script>
    $("#robloxThreadReplySignatureArea").text(localStorage.getItem("roblox_signature_v1") || "")
    $(document).on('click', '#robloxThreadCreateOnClick', function(e) {
        e.preventDefault();
        var btn = $(this);
        btn.attr('disabled', 'disabled');
        var signature = $("#robloxThreadReplySignatureArea").val();
        localStorage.setItem("roblox_signature_v1", signature || "");
        $.ajax({
            method: "POST",
            url: "/Forum/SubmitPost.aspx",
            data: {
                "body": $('#robloxThreadReplyBodyTextArea').val() + (signature ? "\\n\\n" + signature : ""),
                "title": $('#robloxThreadSubjectTextArea').val(),
