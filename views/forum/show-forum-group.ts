...
<div id="forum-nav" style="text-align: right">
	...
	<a id="ctl00_cphRoblox_NavigationMenu2_ctl00_SearchMenu" class="menuTextLink" href="/Forum/Search/default.aspx">Search</a>
            ...
            <nobr>
                ...
                <a id="ctl00_cphRoblox_ThreadView1_ctl00_Whereami1_ctl00_LinkForumGroup" class="linkMenuSink notranslate" href="/Forum/ShowForumGroup.aspx?ForumGroupID=${groups[0].id
		}">${xss(groups[0].name)}</a>
            </nobr>
                        ...
                        <tr class="forum-table-row">
							...
							? `
                                ...
                                <span class="normalTextSmaller">
                                    <div>
                                        <b>${moment(item.createdAt).format(
								'hh:MM A'
							)}</b>
                                    </div>
                                    <div>
