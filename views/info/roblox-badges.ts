...
<link onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' rel='stylesheet' data-bundlename='Footer' href='/rbxcdn/css/55b250e8473888792f885d898973a13692fb22157baf61aaffa62ce4545f3408.css' />
    ...
    <link rel="canonical" href="https://www.roblox.com/info/roblox-badges" />
...
<link onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' rel='stylesheet'  href='/rbxcdn/static/css/page___751195a8d537dfdb193007331fb40a0a_m.css/fetch' />
            ...
            <ul class="stack-list">
                    <li id="Badge18" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/6c2a598114231066a386fa716ac099c4.png" alt="Welcome To The Club" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Welcome To The Club Badge</h3>
                            <p>This badge is awarded to players who have ever belonged to the illustrious Builders Club. These players are part of a long tradition of Roblox greatness.</p>
                        </div>
                    ...
                    <li id="Badge11" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/3b3ab51727ad660e1569cb53e0b2d4a5.png" alt="Builders Club" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Builders Club Badge</h3>
                            <p>Members of the illustrious Builders Club display this badge proudly. The Builders Club is a paid premium service. Members receive several benefits: they earn a daily income of 15 Robux, they can sell their creations to others in the Roblox Catalog, they get the ability to browse the web site without external ads, and they receive the exclusive Builders Club construction hat.</p>
                        </div>
                        <div style="clear: both"></div>
					</li>
					...
					<li id="Badge16" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/7df6357ab1eb2dcf5267d2c5184732ab.png" alt="Outrageous Builders Club" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Outrageous Builders Club Badge</h3>
                            <p>Members of Outrageous Builders Club are VIP Robloxians. They are the cream of the crop. The Outrageous Builders Club is a paid premium service. Members receive 100 groups, 60 Robux per day, and many other benefits.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
            </ul>
        ...
        <div class="stack">
            ...
            <ul class="stack-list">
                    ...
                    <li id="Badge12" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/b7e6cabb5a1600d813f5843f37181fa3.png" alt="Veteran" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Veteran Badge</h3>
                    ...
                    <li id="Badge2" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/5eb20917cf530583e2641c0e1f7ba95e.png" alt="Friendship" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Friendship Badge</h3>
                            <p>This badge is given to players who have embraced the Roblox community and have made at least 20 friends. People who have this badge are good people to know and can probably help you out if you are having trouble.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
                    <li id="Badge14" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/b853909efc7fdcf590363d01f5894f09.png" alt="Ambassador" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                    ...
                    <li id="Badge8" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/01044aca1d917eb20bfbdc5e25af1294.png" alt="Inviter" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Inviter Badge</h3>
        ...
        <div class="stack">
            ...
            <ul class="stack-list">
                    <li id="Badge6" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/b66bc601e2256546c5dd6188fce7a8d1.png" alt="Homestead" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                    ...
                    <li id="Badge7" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/49f3d30f5c16a1c25ea0f97ea8ef150e.png" alt="Bricksmith" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Bricksmith Badge</h3>
                            <p>The Bricksmith badge is earned by having a popular personal place. Once your place has been visited 1000 times, you will receive this award. Robloxians with Bricksmith badges are accomplished builders who were able to create a place that people wanted to explore a thousand times. They no doubt know a thing or two about putting bricks together.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
                    <li id="Badge17" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/45710972c9c8d556805f8bee89389648.png" alt="Official Model Maker" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Official Model Maker Badge</h3>
                            <p>This badge is awarded to players whose creations are so awesome, Roblox endorsed them. Owners of this badge probably have great scripting and building skills.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
            </ul>
        ...
        <div class="stack">
            ...
            <ul class="stack-list">
                    <li id="Badge3" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/8d77254fc1e6d904fd3ded29dfca28cb.png" alt="Combat Initiation" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Combat Initiation Badge</h3>
                            <p>This badge was granted when a player scored 10 victories in games that use classic combat scripts. It was retired Summer 2015 and is no longer attainable.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
                    <li id="Badge4" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/0a010c31a8b482731114810590553be3.png" alt="Warrior" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Warrior Badge</h3>
                            <p>This badge was granted when a player scored 100 or more victories in games that use classic combat scripts. It was retired Summer 2015 and is no longer attainable.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
                    <li id="Badge5" class="divider-bottom stack-row">
                        <div class="badge-image">
                                <img src="/rbxcdn/images/139a7b3acfeb0b881b93a40134766048.png" alt="Bloxxer" width="75" height="75" />
                        </div>
                        <div class="badge-description">
                            <h3>Bloxxer Badge</h3>
                            <p>This badge was granted when a player scored at least 250 victories, and fewer than 250 wipeouts, in games that use classic combat scripts. It was retired Summer 2015 and is no longer attainable.</p>
                        </div>
                        <div style="clear: both"></div>
                    </li>
            </ul>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='Navigation' type='text/javascript' src='/rbxcdn/js/4ca60e0154c8002351e89502e3eb17457339d3c05939a3b18554eb955a06a302.js'></script>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='DynamicLocalizationResourceScript_Common.AlertsAndOptions' type='text/javascript' src='/rbxcdn/js/1e148db91b54661ad571d33042e374da2c6d63e6bdeb458c770c6cd5b8442ffb.js'></script>
    ...
    <script>
        Roblox.XsrfToken.setToken('LbLyoyYZRbMi');
    </script>
...
<script type="text/javascript">
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='page' type='text/javascript' src='/rbxcdn/js/631cb22dc68ab5faf6bed9d311c3ecea.js'></script>
...
<script type="text/template" id="push-notifications-successfully-disabled-template">
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='pageEnd' type='text/javascript' src='/rbxcdn/js/af827b2f166675483d629c7da7799872.js'></script>
...
export default (userInfo: IUserInfo): string => {
	return formatView(html, userInfo);
}