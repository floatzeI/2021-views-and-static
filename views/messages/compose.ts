...
<head data-machine-id="${process.env.MACHINE_ID || 'WEB0'}">
    ...
    <link rel="canonical" href="https://www.roblox.com/messages/compose?recipientId=2113568" />
...
<link onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' rel='stylesheet' data-bundlename='ComposeMessage' href='/rbxcdn/css/c508fe01a01b0aa321049af87bb97d1bbcf914f6173ce6104d1a8caee014592d.css' />
...
<div class="messages-container">
    ...
    <div class="section-content">
        <div id="success-block" class="clearfix new-message-success success-block">
            <div id="message-success" class="status-confirm"></div>
            <div id="navigationsuccess" class="clearfix new-message-back navigationsuccess">
                <a class="btn-control-xs" title="Go to Previous Page Button" onclick="history.back();return false;" href="#">
        ...
        <div id="newmessage" class="new-message">
                <div id="newmessage-content" class="new-message-content">
                    <div class="row border">
                        <div class="text-label">To:</div>
                        <div class="message-title"><a href="https://www.roblox.com/users/2113568/profile">Aulzot</a>
                        </div>
                    </div>
                    <div class="row border">
                        <div class="text-label">Subject:</div>
                        <div class="input-block">
                            <input type="text" class="text new-message-subject" id="subject" maxlength="256">
                        </div>
                    </div>
                    <input type="hidden" id="recipientId" value="2113568">
                    <div class="message-content">
                        <textarea rows="2" cols="20" id="body" class="messages-reply-box border text-box text new-message-body" placeholder="Write your message..."></textarea>
                    </div>
                  
                    <div class="new-message-footer">
                        <div class="action-buttons">
                            <a class="btn-primary-md btn-min-width send-btn" id="send-btn">Send</a>
                            <a class="text-link" onclick="history.back();return false;">Discard</a>
                        </div>
                        <div class="text-warning xsmall">
                            Remember, Roblox staff will never ask you for your password. People who ask for your password are trying to steal your account.
                        </div>
                    </div>
                </div>
        </div>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='DynamicLocalizationResourceScript_Common.AlertsAndOptions' type='text/javascript' src='/rbxcdn/js/1e148db91b54661ad571d33042e374da2c6d63e6bdeb458c770c6cd5b8442ffb.js'></script>
    ...
    <script>
        Roblox.XsrfToken.setToken('4SSvArq0pieO');
    </script>
...
<script type="text/javascript">
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='page' type='text/javascript' src='/rbxcdn/js/1f1f174a3a03d1fcda43ae13f040eec7.js'></script>
...
<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='ComposeMessage' type='text/javascript' src='/rbxcdn/js/378736b1e23f17f5997c6dd89ccc06540404627b2e9b13145218c482954409c0.js'></script>

<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='DynamicLocalizationResourceScript_Feature.Messages' type='text/javascript' src='/rbxcdn/js/dbbadcf2e4058d442a6a4aa2e77ad791c75889f2cf47e039ecd63ae1c02996ab.js'></script>

<script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='DynamicLocalizationResourceScript_Feature.Messages' type='text/javascript' src='/rbxcdn/js/c99a157959044cb8ec49388c31f03ecd9be1dec4f676ee4c8f3124a070ebf49e.js'></script>
...
<script type="text/template" id="push-notifications-successfully-disabled-template">
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='pageEnd' type='text/javascript' src='/rbxcdn/js/2ca03e771185e374f79bc0e3590fcf4a.js'></script>
...
export default (
	...
	const data = formatView(html, session);
	return data
		.replace(/2113568/g, recipient.userId.toString())
		.replace(/Aulzot/g, recipient.username);
};
